...
import 'package:books/presentation/widgets/favorite_icon_widget.dart';
...
class DetailsScreen extends StatefulWidget {
  const DetailsScreen({Key? key, required this.id, this.boxColor})
      : super(key: key);
              ...
              ? FutureBuilder(
                  ...
                  builder: (context, AsyncSnapshot<DetailModel> snapshot) {
                    ...
                    if (snapshot.hasData) {
                      ...
                      var description = snapshot.data?.volumeInfo?.description;
                      var authors = snapshot.data?.volumeInfo?.authors ?? [];
                      var thumbnail =
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      FavoriteIconWidget(item: snapshot.data)
                                    ],
                                  ),
                                  const SizedBox(
                                    height: 20,
